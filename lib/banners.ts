...
export const POST_BANNERS: Record<number, BannerConfig[]> = {
  ...
  603: [INFRAAI_BANNER],
  604: [INFRAAI_BANNER],
  600: [INFRAAI_BANNER, VIRTUALOFFICE1_BANNER],
  602: [INFRAAI_BANNER],
  ...
  702: [GAIATE_BANNER],
  703: [FXBROAD_BANNER],
  704: [DMMFX_BANNER, FXTF_BANNER, GAIATE_BANNER],  // ひまわり証券review: 他社FXバナー表示
  707: [FXBROAD_BANNER],
  754: [DMMFX_BANNER],
  755: [DMMFX_BANNER],
  ...
  801: [EPOS_CARD_BANNER],  // 楽天カードreview: 楽天バナーなし→エポスカード代替
  ...
  910: [MCNURSENET_BANNER, MCCAREGIVING_BANNER],
