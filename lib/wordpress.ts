...
const PINNED_TOP_BY_CATEGORY: Record<number, number[]> = {
  ...
  54: [285, 367, 385, 388, 389, 392, 393, 394, 1013],  // English: ランキング→各社+ランカル→AQUES→ワールドアイキッズ→eスピ
  ...
  61: [900, 997, 998, 999, 1000, 1001, 1012],  // 転職: LP→circus→iDA→オイシルキャリア→エストレ→karricon→ミライフ
