...
const PINNED_TOP_BY_CATEGORY: Record<number, number[]> = {
  48: [189, 205, 206, 261, 335],  // VPN: ランキング→NordVPN→Surfshark→Millen→Netflix
  51: [210, 209, 259, 295],       // Server: ランキング→Xserver→ConoHa→Kinsta
  54: [285, 367, 369, 385],       // English: ランキング→BestTeacher→Tintoru→GSA
  55: [287, 371, 373],            // School: ランキング→LifeIstech→Winスクール
  56: [289],                      // Career: エストレ
  57: [600],                      // Fukugyo: SideLine
};
