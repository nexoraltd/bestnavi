...
const CATEGORY_FAQ: Record<string, { q: string; a: string }[]> = {
  ...
  tenshoku: [
    { q: "転職エージェントは完全無料ですか？", a: "はい。転職エージェントは求職者側は完全無料です。費用は採用企業が負担する仕組みになっています。" },
    { q: "在職中でも転職活動できますか？", a: "可能です。エージェントを利用すれば、スケジュール調整・書類作成・面接対策をサポートしてもらいながら、現職と並行して転職活動を進められます。" },
    { q: "転職エージェントと転職サイトの違いは？", a: "転職サイトは自分で求人を探して応募するのに対し、転職エージェントは担当者が求人提案・書類添削・面接対策・条件交渉まで一貫サポートします。初めての転職にはエージェントが向いています。" },
    { q: "専門特化型と総合型、どちらがいいですか？", a: "IT・アパレル・生鮮など特定業界を目指す場合は専門特化型が強く、幅広い選択肢を見たい場合は総合型がおすすめです。両方に登録するのが最も効率的です。" },
  ],
  kuruma: [
    { q: "車の買取価格はどこで査定しても同じですか？", a: "査定業者によって最大数十万円の差が出ることがあります。一括査定サービスを使って複数社の査定額を比較するのが高く売るための基本です。" },
    { q: "査定だけでも申し込めますか？", a: "はい。査定は無料で、売却義務もありません。気軽に査定額の目安を確認してから判断できます。" },
    { q: "廃車・事故車でも買取してもらえますか？", a: "ハイシャルなど廃車買取専門業者は、走行不能・事故車・年式の古い車でも無料引き取り・買取対応しています。" },
    { q: "マイカーリースと購入・ローンどちらがお得ですか？", a: "月々の出費を一定にしたい場合はリースが向いています。エンキロのような距離課金型リースはあまり乗らない方ほど割安になります。長期保有・カスタマイズ重視なら購入が向いています。" },
  ],
  "houjin-card": [
    { q: "設立間もない法人でもカードは作れますか？", a: "ETC協同組合の法人ETCカードや一部の法人カードは設立直後・赤字決算でも発行可能なケースがあります。審査基準は各社異なるため、複数社への同時申請がおすすめです。" },
    { q: "個人事業主でも法人カードは作れますか？", a: "はい。法人カード・ETCカードの多くは個人事業主も申込対象です。屋号付き口座がなくても個人名義で申し込めるサービスもあります。" },
    { q: "法人ETCカードのメリットは？", a: "高速料金を一括で管理・精算でき、複数車両分を月次請求書払いにまとめられます。ガソリンカードと組み合わせると燃料費の経費処理も効率化できます。" },
    { q: "FASIOビジネスカードとETCカードの違いは？", a: "FASIOはVisaビジネスカードにETCが付帯した一体型です。法人ETCカード単独と比べ、仕入れ・出張費など幅広い経費をまとめて管理できます。" },
  ],
  kaikei: [
    { q: "freeeとマネーフォワード、どちらがいいですか？", a: "個人事業主の確定申告ならfreeeが使いやすく、法人で経理業務全般を効率化したい場合はマネーフォワード クラウドが向いています。どちらも無料トライアルがあります。" },
    { q: "弥生とクラウド会計の違いは何ですか？", a: "弥生会計はインストール型ソフトで動作が安定しており税理士との連携実績も豊富です。クラウド型（freee・マネーフォワード）はスマホ対応・銀行自動連携など利便性が高いのが特徴です。" },
    { q: "会計ソフトを使うと確定申告が楽になりますか？", a: "はい。銀行・クレジットカードと連携すれば仕訳が自動化され、青色申告決算書・確定申告書も自動作成できます。手書き・Excelと比べて大幅に作業時間を削減できます。" },
    { q: "インボイス制度・電子帳簿保存法に対応していますか？", a: "freee・マネーフォワード・弥生はいずれもインボイス制度対応（適格請求書発行・登録番号管理）および電子帳簿保存法に対応しています。" },
  ],
  "wifi-sim": [
    { q: "格安SIMと大手キャリアの違いは何ですか？", a: "格安SIM（MVNO）は大手キャリアの回線を借りてサービスを提供するため、月額料金が大手の1/3〜1/5程度になります。品質は回線によって異なりますが、docomo回線のMVNOは安定性が高いです。" },
    { q: "審査なしで使えるSIM・WiFiはありますか？", a: "スマホプリペイドはSIM契約不要・審査なしで使えます。ポケットWiFiレンタルも本人確認のみで審査不要のサービスが多いです。" },
    { q: "格安SIMに乗り換えるとどれくらい節約できますか？", a: "大手キャリアから格安SIMに乗り換えると、月額1,000〜3,000円程度の節約になるケースが多いです。年間で12,000〜36,000円の節約効果があります。" },
    { q: "データ容量が足りなくなった場合は？", a: "多くの格安SIMはアプリやWebから追加データを購入できます。ポケットWiFiの場合は大容量プランへの変更や追加購入で対応できます。" },
  ],
  "gift-card": [
    { q: "デジタルギフトカードはどこで使えますか？", a: "VisaのデジタルギフトはオンラインショッピングでVisa決済が使えるサイトであれば基本的に利用可能です。Amazonや各種ECサイトでの買い物に使えます。" },
    { q: "金券ねっとで安全に取引できますか？", a: "金券ねっとは金券・商品券の売買プラットフォームです。取引の際は出品者の評価やサービスの利用規約を事前に確認することをおすすめします。" },
    { q: "ギフトカードはプレゼントに使えますか？", a: "はい。デジタルギフトカードはメールで送れるため、誕生日・記念日・お礼など幅広いシーンでプレゼントとして活用できます。" },
    { q: "ギフトカードに有効期限はありますか？", a: "サービスによって異なります。Visaのデジタルギフトは有効期限がカード面に記載されています。期限切れの場合は利用できないため、購入後は早めに使用することをおすすめします。" },
  ],
};
