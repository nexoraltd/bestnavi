  ...
  return (
    <div style={{ background: "var(--bg-warm)", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "clamp(20px, 4vw, 32px) clamp(12px, 4vw, 16px)" }}>
        <article style={{ background: "#fff", borderRadius: 12, border: "1px solid var(--border)", padding: "clamp(16px, 4vw, 32px)" }}>
          ...
          <p style={{ fontSize: 14, color: "var(--text-secondary)", lineHeight: 1.8, marginBottom: 16 }}>ベストナビは、VPN・FX口座・レンタルサーバー・オンライン英会話・プログラミングスクール・ITキャリア・副業サービスなど、提携済みのサービスを公式情報・料金・機能をもとに比較し、カテゴリ別のランキングとまとめを提供する情報サイトです。</p>
